...
# --- CONFIGURATION (CORRIGÉE AVEC LE 'r' DEVANT LA CLÉ) ---
# Le r"..." permet d'éviter l'erreur SyntaxError: (unicode error)
...
# Nettoyage de la clé pour Google
CLE_PROPRE = RAW_KEY.replace(r"\n", "\n")
